...
${val.stack}`;
    ...
    var path2 = require("path").join(__dirname, "core_bg.wasm");
    var bytes2 = require("fs").readFileSync(path2);
...
var require_configuration = __commonJS({
  "node_modules/.pnpm/@1password+sdk@0.4.0/node_modules/@1password/sdk/dist/configuration.js"(exports2) {
    ...
    exports2.DesktopAuth = DesktopAuth2;
...
var DEFAULT_DATA_DIR = (0, import_node_path.join)((0, import_node_os.homedir)(), ".ucan-kms");
